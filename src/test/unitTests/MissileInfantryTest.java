...
public class MissileInfantryTest {
    @Test
    /**
     * test that range is initialised to true
     */
    public void testMissileInfantryRange() {
        MissileInfantry a = new MissileInfantry(1);
     ...
     */
    public void testMissileInfantryRangeAttackDamage() {
        MissileInfantry a = new MissileInfantry(1);
     ...
     */
    public void testMissileInfantryIdempotent() {
        MissileInfantry a = new MissileInfantry(1);
        MissileInfantry b = new MissileInfantry(1);
        assertEquals(true, a.equals(b));
    }

    @Test
    /**
     * Test the clone method in MissileInfantry
     */
    public void testMissileInfantryClone() {
