package unsw.gloriaromanus.unit.artillery;
...
public class Artillery implements Unit {
    ...
    /**
     * Constructs an artillery unit
     * 
     * @param recruitmentStart the round in which the unit is recuited
     */
    public Artillery(int recruitmentStart) {
        this.cost = 10;
        this.upkeepCost = 5;
        this.turnsToRecruit = 1;
        this.recruitmentStart = recruitmentStart;
        this.movementPoints = 4;
        this.currentMovementPoints = 4;
        this.ranged = true;
    ...
    /**
     * Store artillery details into a JSONObject
     * 
     * @return JSONObject of artillery details
     */
    ...
    public Unit clone(Unit unit) {
        ...
        Artillery copy = new Artillery(recruitmentStart);
