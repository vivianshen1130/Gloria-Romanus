...
public class Cavalry implements Unit {
    ...
    private double chargeStat; // the charge statistic of the unit
    ...
    /***
     * construct the cavalry unit class
     * 
     * @param recruitmentStart the round in which the unit was rectruited
     */
    public Cavalry(int recruitmentStart) {
        this.cost = 10;
        this.upkeepCost = 5;
        this.turnsToRecruit = 1;
        this.recruitmentStart = recruitmentStart;
        this.movementPoints = 15;
        this.currentMovementPoints = 15;
        this.chargeStat = 10;
        this.ranged = false;
    ...
    public double getMeleeAttackDamage() {
        return meleeAttackDamage + chargeStat;
    }
    ...
    /**
     * Store cavalry details into a JSONObject
     * 
     * @return JSONObject of cavalry details
     */
    public JSONObject saveGame() {
        ...
        unitDetails.put("chargeStat", chargeStat);
    ...
    public String toString() {
        return getClass().toString() + ", turns to recruit: " + turnsToRecruit + ", recruitment start: "
                + recruitmentStart + ", movement points: " + movementPoints + ", charge statistic: " + chargeStat
                + ", ranged: " + ranged + ", number of troops: " + numTroops + ", armour: " + armour + ", morale: "
                + morale + ", speed: " + speed + ", melee attack damage: " + meleeAttackDamage
                + ", range attack damage: " + rangedAttackDamage + ", defense skill: " + defenseSkill
    ...
    public boolean equals(Object obj) {
        ...
        Cavalry t = (Cavalry) obj;
        return (turnsToRecruit == t.turnsToRecruit && recruitmentStart == t.recruitmentStart
                && movementPoints == t.movementPoints && chargeStat == t.chargeStat && ranged == t.ranged
                && numTroops == t.numTroops && armour == t.armour && morale == t.morale && speed == t.speed
